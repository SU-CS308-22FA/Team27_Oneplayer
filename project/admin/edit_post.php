...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="latest game scores">Latest Game Scores</option>
         <option value="players on press">Players on Press</option>
         <option value="words from players">Words from Players</option>
